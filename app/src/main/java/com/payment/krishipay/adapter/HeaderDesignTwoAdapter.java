...
public class HeaderDesignTwoAdapter extends RecyclerView.Adapter<HeaderDesignTwoAdapter.ViewHolder> {

    private Context context;
    private List<ActivityListModel> activityListModels;

    public HeaderDesignTwoAdapter(Context context, List<ActivityListModel> activityListModels) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_item_view_design_two, parent, false);
