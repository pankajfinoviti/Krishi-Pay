...
public class HeaderAdapter extends RecyclerView.Adapter<HeaderAdapter.ViewHolder> {
    ...
    public HeaderAdapter(Context context, List<ActivityListModel> activityListModels) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_transfermoney_row_dynamic, parent, false);
