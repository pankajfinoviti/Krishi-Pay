...
import com.payment.krishipay.views.reports.adapter.UPITranAdapter;
...
public class UpiTransactionReport extends AppCompatActivity implements RequestResponseLis {
    private static final int REQUEST_COUNT = 0;
    int pastVisiblesItems, visibleItemCount, totalItemCount;
    private List<UPIModel> dataList;
    private RecyclerView listView;
    private UPITranAdapter adapter;
    ...
    private void initToolbar() {
        ...
        imgFilter.setOnClickListener(v -> {
            Intent i = new Intent(UpiTransactionReport.this, FilterView.class);
            startActivity(i, ActivityOptions.makeSceneTransitionAnimation(UpiTransactionReport.this).toBundle());
        });
    ...
    private void initReportSlider() {
        adapter = new UPITranAdapter(this, dataList);
    ...
    public void onSuccessRequest(String JSonResponse) {
        ...
        try {
            ...
            if (object.has("data")) {
                ...
                dataList.addAll(AppHandler.parseUpiModelReport(this, bannerArray));
    ...
    private void initReportPDFData() {
        String[] keys = {"ID", "Mobile", "Amount", "Balance", "Type", "Via", "Date", "Status"};
        List<List<InvoiceModel>> modelList = new ArrayList<>();
        for (UPIModel model : dataList) {
            ...
            invoiceModels.add(new InvoiceModel("Date", model.getCreatedAt()));
