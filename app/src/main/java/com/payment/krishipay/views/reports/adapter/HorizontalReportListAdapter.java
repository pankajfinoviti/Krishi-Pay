...
public class HorizontalReportListAdapter extends RecyclerView.Adapter<HorizontalReportListAdapter.ViewHolder> {

    private Context context;
    private List<ActivityListModel> activityListModels;

    public HorizontalReportListAdapter(Context context, List<ActivityListModel> activityListModels) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_report_row, parent, false);
