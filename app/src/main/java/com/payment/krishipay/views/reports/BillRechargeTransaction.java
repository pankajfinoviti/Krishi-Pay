...
import com.payment.krishipay.views.reports.adapter.BillTranAdapter;
...
public class BillRechargeTransaction extends AppCompatActivity implements RequestResponseLis {
    private static final int REQUEST_COUNT = 0;
    int pastVisiblesItems, visibleItemCount, totalItemCount;
    private List<BillRechargeModel> dataList;
    private RecyclerView listView;
    private BillTranAdapter adapter;
    ...
    private void initToolbar() {
        ...
        imgFilter.setOnClickListener(v -> {
            Intent i = new Intent(BillRechargeTransaction.this, FilterView.class);
            startActivity(i, ActivityOptions.makeSceneTransitionAnimation(BillRechargeTransaction.this).toBundle());
        });
    ...
    private void initReportSlider() {
        adapter = new BillTranAdapter(this, dataList, TYPE);
    ...
    public void onSuccessRequest(String JSonResponse) {
        ...
        try {
            ...
            if (object.has("data")) {
                ...
                dataList.addAll(AppHandler.parseBillRechargeData(this, bannerArray));
    ...
    private void initReportPDFData() {
        String[] keys = {"ID", "Number", "Amount", "Charge", "Balance", "Via", "Trans Type", "Provider Name", "Status"};
        List<List<InvoiceModel>> modelList = new ArrayList<>();
        for (BillRechargeModel model : dataList) {
            ...
            invoiceModels.add(new InvoiceModel("Provider Name", model.getProvidername()));
