package com.payment.krishipay.permission;
...
public class PermissionsActivity extends Activity {
    ...
    private AppPermissions.Options options;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        options = (AppPermissions.Options) intent.getSerializableExtra(EXTRA_OPTIONS);
        if (options == null) {
            options = new AppPermissions.Options();
        }
        ...
        if (noRationale || TextUtils.isEmpty(rationale)) {
            AppPermissions.log("No rationale.");
            requestPermissions(toArray(deniedPermissions), RC_PERMISSION);
        } else {
            AppPermissions.log("Show rationale.");
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        if (grantResults.length == 0) {
            ...
            if (deniedPermissions.size() == 0) {
                AppPermissions.log("Just allowed.");
                grant();
            } else {
    ...
    private void sendToSettings() {
        ...
        AppPermissions.log("Ask to go to settings.");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == RC_SETTINGS && permissionHandler != null) {
            AppPermissions.check(this, toArray(allPermissions), null, options, permissionHandler);
        }
